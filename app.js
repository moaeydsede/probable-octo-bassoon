...
/* ============ Nav ============ */
const NAV = [
  { id:"dashboard", title:"الرئيسية", view:"view_dashboard", roles:["admin","user"] },
  { id:"company", title:"بيانات الشركة", view:"view_company", roles:["admin"] },
  { id:"accounts", title:"دليل الحسابات", view:"view_accounts", roles:["admin"] },
  { id:"items", title:"دليل المواد", view:"view_items", roles:["admin"] },
  { id:"wh", title:"المستودعات", view:"view_wh", roles:["admin"] },

  { id:"sales", title:"فواتير المبيعات", view:"view_sales", roles:["admin","user"], badgeKey:"sales" },
  { id:"purchases", title:"فواتير المشتريات", view:"view_purchases", roles:["admin","user"], badgeKey:"purchases" },
  { id:"vouchers", title:"السندات", view:"view_vouchers", roles:["admin","user"], badgeKey:"vouchers" },

  { id:"moves", title:"حركة مادة", view:"view_moves", roles:["admin"] },
  { id:"stocktake", title:"جرد مواد", view:"view_stocktake", roles:["admin"] },

  { id:"cc", title:"مراكز الكلفة", view:"view_cc", roles:["admin"] },
  { id:"journal", title:"قيود يومية", view:"view_journal", roles:["admin"] },
  { id:"gl", title:"دفتر الأستاذ", view:"view_gl", roles:["admin"] },
  { id:"statement", title:"كشف حساب", view:"view_statement", roles:["admin"] },

  { id:"users", title:"المستخدمون", view:"view_users", roles:["admin"] },
];
